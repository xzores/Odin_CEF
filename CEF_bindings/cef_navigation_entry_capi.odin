...
cef_navigation_entry_t :: struct {
    ...
    get_url: proc "c" (self: ^cef_navigation_entry_t) -> cef_string_userfree,
    get_display_url: proc "c" (self: ^cef_navigation_entry_t) -> cef_string_userfree,
    get_original_url: proc "c" (self: ^cef_navigation_entry_t) -> cef_string_userfree,
    get_title: proc "c" (self: ^cef_navigation_entry_t) -> cef_string_userfree,
