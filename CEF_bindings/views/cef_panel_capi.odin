...
cef_panel_t :: struct {
	...
	set_bounds: proc "c" (self: ^cef_panel_t, bounds: ^cef_rect),
	get_bounds: proc "c" (self: ^cef_panel_t) -> cef_rect,
	get_bounds_in_screen: proc "c" (self: ^cef_panel_t) -> cef_rect,
	set_size: proc "c" (self: ^cef_panel_t, size: ^cef_size),
	get_size: proc "c" (self: ^cef_panel_t) -> cef_size,
	set_position: proc "c" (self: ^cef_panel_t, position: ^cef_point),
	get_position: proc "c" (self: ^cef_panel_t) -> cef_point,
	...
	set_child_view_bounds: proc "c" (self: ^cef_panel_t, view: ^cef_view_t, bounds: ^cef_rect),
	get_child_view_bounds: proc "c" (self: ^cef_panel_t, view: ^cef_view_t) -> cef_rect,
} 