...
cef_menu_button_t :: struct {
    ...
    show_menu: proc "c" (self: ^cef_menu_button_t, menu_model: ^Menu_model, screen_point: ^cef_point, anchor_position: cef_menu_anchor_position_t),
    ...
    set_horizontal_alignment: proc "c" (self: ^cef_menu_button_t, alignment: Horizontal_alignment_t),
    set_minimum_size: proc "c" (self: ^cef_menu_button_t, size: ^cef_size),
    set_maximum_size: proc "c" (self: ^cef_menu_button_t, size: ^cef_size),
