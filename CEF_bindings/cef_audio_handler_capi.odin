...
audio_handler :: struct {
	...
	///
	get_audio_parameters: proc "c" (self: ^audio_handler, browser: ^Browser, params: ^audio_parameters) -> b32,
	...
	///
	on_audio_stream_started: proc "c" (self: ^audio_handler, browser: ^Browser, params: ^audio_parameters, channels: c.int),
	...
	///
	on_audio_stream_packet: proc "c" (self: ^audio_handler, browser: ^Browser, data: ^[^]f32, frames: c.int, pts: i64),
	...
	///
	on_audio_stream_stopped: proc "c" (self: ^audio_handler, browser: ^Browser),
	...
	///
	on_audio_stream_error: proc "c" (self: ^audio_handler, browser: ^Browser, message: ^cef_string),
} 