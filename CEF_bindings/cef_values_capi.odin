...
cef_binary_value :: struct {
	...
	is_valid: proc "c" (self: ^cef_binary_value) -> c.int,

	// Returns 1 if this object is currently owned by another object.
	is_owned: proc "c" (self: ^cef_binary_value) -> c.int,

	// Returns 1 if this and |that| have the same underlying data.
	is_same: proc "c" (self: ^cef_binary_value, that: ^cef_binary_value) -> c.int,

	// Returns 1 if this and |that| have an equivalent underlying value (not necessarily the same object).
	is_equal: proc "c" (self: ^cef_binary_value, that: ^cef_binary_value) -> c.int,

	// Returns a copy of this object; data is also copied.
	copy: proc "c" (self: ^cef_binary_value) -> ^cef_binary_value,

	// Returns pointer to the start of the memory block. Valid while the cef_binary_value is alive.
	get_raw_data: proc "c" (self: ^cef_binary_value) -> rawptr,

	// Returns the data size.
	get_size: proc "c" (self: ^cef_binary_value) -> c.size_t,

	// Read up to |buffer_size| bytes into |buffer| starting at |data_offset|. Returns number of bytes read.
	get_data: proc "c" (self: ^cef_binary_value, buffer: rawptr, buffer_size: c.size_t, data_offset: c.size_t) -> c.size_t,
}
...
cef_dictionary_value :: struct {
	...
	// (e.g., list/dictionary) that is later modified or destroyed. Do not call other
	// functions if this returns 0.
	is_valid: proc "c" (self: ^cef_dictionary_value) -> c.int,

	// Returns 1 if this object is currently owned by another object.
	is_owned: proc "c" (self: ^cef_dictionary_value) -> c.int,

	// Returns 1 if values are read-only (some APIs expose read-only objects).
	is_read_only: proc "c" (self: ^cef_dictionary_value) -> c.int,

	// Returns 1 if this and |that| share the same underlying data (mutations affect both).
	is_same: proc "c" (self: ^cef_dictionary_value, that: ^cef_dictionary_value) -> c.int,

	// Returns 1 if this and |that| have equivalent values (not necessarily the same object).
	is_equal: proc "c" (self: ^cef_dictionary_value, that: ^cef_dictionary_value) -> c.int,

	// Returns a writable copy. If exclude_empty_children is 1, NULL dictionaries/lists are excluded.
	copy: proc "c" (self: ^cef_dictionary_value, exclude_empty_children: c.int) -> ^cef_dictionary_value,

	// Number of values.
	get_size: proc "c" (self: ^cef_dictionary_value) -> c.size_t,

	// Removes all values. Returns 1 on success.
	clear: proc "c" (self: ^cef_dictionary_value) -> c.int,

	// Returns 1 if a value exists for |key|.
	has_key: proc "c" (self: ^cef_dictionary_value, key: ^cef_string) -> c.int,

	// Reads all keys into |keys|.
	get_keys: proc "c" (self: ^cef_dictionary_value, keys: string_list) -> c.int,

	// Removes the value at |key|. Returns 1 on success.
	remove: proc "c" (self: ^cef_dictionary_value, key: ^cef_string) -> c.int,

	// Returns the value type at |key|.
	get_type: proc "c" (self: ^cef_dictionary_value, key: ^cef_string) -> cef_value_type,

	// Returns the value at |key|. Simple types copy data; complex types (binary/dict/list) reference existing data.
	get_value: proc "c" (self: ^cef_dictionary_value, key: ^cef_string) -> ^cef_value,

	// Returns the value at |key| as bool.
	get_bool: proc "c" (self: ^cef_dictionary_value, key: ^cef_string) -> c.int,

	// Returns the value at |key| as int.
	get_int: proc "c" (self: ^cef_dictionary_value, key: ^cef_string) -> c.int,

	// Returns the value at |key| as double.
	get_double: proc "c" (self: ^cef_dictionary_value, key: ^cef_string) -> f64,

	// Returns the value at |key| as string. Result must be freed with cef_string_userfree_free().
	get_string: proc "c" (self: ^cef_dictionary_value, key: ^cef_string) -> cef_string_userfree,

	// Returns the value at |key| as binary (references existing data).
	get_binary: proc "c" (self: ^cef_dictionary_value, key: ^cef_string) -> ^cef_binary_value,

	// Returns the value at |key| as dictionary (references existing data; mutations modify this object).
	get_dictionary: proc "c" (self: ^cef_dictionary_value, key: ^cef_string) -> ^cef_dictionary_value,

	// Returns the value at |key| as list (references existing data; mutations modify this object).
	get_list: proc "c" (self: ^cef_dictionary_value, key: ^cef_string) -> ^cef_list_value,

	// Sets the value at |key|. Returns 1 on success. Simple data is copied; complex data is referenced.
	set_value: proc "c" (self: ^cef_dictionary_value, key: ^cef_string, value: ^cef_value) -> c.int,

	// Sets null at |key|. Returns 1 on success.
	set_null: proc "c" (self: ^cef_dictionary_value, key: ^cef_string) -> c.int,

	// Sets bool at |key|. Returns 1 on success.
	set_bool: proc "c" (self: ^cef_dictionary_value, key: ^cef_string, value: c.int) -> c.int,

	// Sets int at |key|. Returns 1 on success.
	set_int: proc "c" (self: ^cef_dictionary_value, key: ^cef_string, value: c.int) -> c.int,

	// Sets double at |key|. Returns 1 on success.
	set_double: proc "c" (self: ^cef_dictionary_value, key: ^cef_string, value: f64) -> c.int,

	// Sets string at |key|. Returns 1 on success.
	set_string: proc "c" (self: ^cef_dictionary_value, key: ^cef_string, value: ^cef_string) -> c.int,
	...
	set_binary: proc "c" (self: ^cef_dictionary_value, key: ^cef_string, value: ^cef_binary_value) -> c.int,

	// Sets dictionary at |key|. Same ownership semantics as set_binary. Returns 1 on success.
	set_dictionary: proc "c" (self: ^cef_dictionary_value, key: ^cef_string, value: ^cef_dictionary_value) -> c.int,

	// Sets list at |key|. Same ownership semantics as set_binary. Returns 1 on success.
	set_list: proc "c" (self: ^cef_dictionary_value, key: ^cef_string, value: ^cef_list_value) -> c.int,
}
...
foreign lib {
	...
	value_create :: proc "c" () -> ^cef_value ---

	/// Creates a new object that is not owned by any other object.
	dictionary_value_create :: proc "c" () -> ^cef_dictionary_value ---

	/// Creates a new object that is not owned by any other object. The specified |data| will be copied.
	binary_value_create :: proc "c" (data: rawptr, data_size: c.size_t) -> ^cef_binary_value ---

	/// Creates a new object that is not owned by any other object.
	list_value_create :: proc "c" () -> ^cef_list_value ---
}
