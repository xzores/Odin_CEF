...
thread_create :: proc "c" (display_name: ^cef_string, priority: Thread_priority, message_loop_type: Message_loop_type, stoppable: b32, Com_init_mode: Com_init_mode) -> ^thread 