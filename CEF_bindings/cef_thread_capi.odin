...
// cef_platform_thread_id is defined in cef_types_capi.odin
// cef_thread_priority is defined in cef_types_capi.odin
// cef_message_loop_type is defined in cef_types_capi.odin
// cef_com_init_mode is defined in cef_types_capi.odin
...
///
thread_create :: proc "c" (display_name: ^cef_string, priority: cef_thread_priority, message_loop_type: cef_message_loop_type, stoppable: b32, com_init_mode: cef_com_init_mode) -> ^thread 