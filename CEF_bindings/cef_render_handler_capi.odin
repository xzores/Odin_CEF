...
render_handler :: struct {
	...
	/// drawn correctly.
	///
	get_screen_info: proc "c" (self: ^render_handler, browser: ^Browser, screen_info: ^cef_screen_info) -> b32,
	...
	///
	on_paint: proc "c" (self: ^render_handler, browser: ^Browser, type: cef_paint_element_type, dirtyRectsCount: c.size_t, dirtyRects: ^cef_rect, buffer: rawptr, width: c.int, height: c.int),
	...
	///
	on_accelerated_paint: proc "c" (self: ^render_handler, browser: ^Browser, type: cef_paint_element_type, dirtyRectsCount: c.size_t, dirtyRects: ^cef_rect, info: ^cef_accelerated_paint_info),

	///
	/// Called to retrieve the size of the touch handle for the specified
	/// |orientation|.
	///
	get_touch_handle_size: proc "c" (self: ^render_handler, browser: ^Browser, orientation: cef_horizontal_alignment, size: ^cef_size),

	///
	/// Called when touch handle state is updated. The client is responsible for
	/// rendering the touch handles.
	///
	on_touch_handle_state_changed: proc "c" (self: ^render_handler, browser: ^Browser, state: ^cef_touch_handle_state),
	...
	/// operation has ended.
	///
	start_dragging: proc "c" (self: ^render_handler, browser: ^Browser, drag_data: ^drag_data, allowed_ops: cef_drag_operations_mask, x: c.int, y: c.int) -> b32,
	...
	/// copy, link).
	///
	update_drag_cursor: proc "c" (self: ^render_handler, browser: ^Browser, operation: cef_drag_operations_mask),
	...
	///
	on_virtual_keyboard_requested: proc "c" (self: ^render_handler, browser: ^Browser, input_mode: cef_text_input_mode),
} 