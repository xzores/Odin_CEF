...
Request :: struct {
    ...
    set_referrer: proc "c" (self: ^Request, referrer_url: ^cef_string, policy: cef_referrer_policy_t),
    get_referrer_url: proc "c" (self: ^Request) -> cef_string_userfree,
    get_referrer_policy: proc "c" (self: ^Request) -> cef_referrer_policy_t,
    ...
    get_resource_type: proc "c" (self: ^Request) -> cef_resource_type_t,
    get_transition_type: proc "c" (self: ^Request) -> cef_transition_type_t,
