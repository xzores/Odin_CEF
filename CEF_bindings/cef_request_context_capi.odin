...
cef_resolve_callback_t :: struct {
    ...
    on_resolve_completed: proc "c" (self: ^cef_resolve_callback_t, result: cef_errorcode_t, resolved_ips: string_list),
}

cef_setting_observer_t :: struct {
    base: cef_base_ref_counted_t,
    on_setting_changed: proc "c" (self: ^cef_setting_observer_t, requesting_url: ^cef_string, top_level_url: ^cef_string, content_type: cef_content_setting_types_t),
}
...
cef_request_context_t :: struct {
    ...
    get_cache_path: proc "c" (self: ^cef_request_context_t) -> cef_string_userfree,
    get_cookie_manager: proc "c" (self: ^cef_request_context_t, callback: ^cef_completion_callback_t) -> ^cef_cookie_manager_t,
    register_scheme_handler_factory: proc "c" (self: ^cef_request_context_t, scheme_name: ^cef_string, domain_name: ^cef_string, factory: ^cef_scheme_handler_factory_t) -> b32,
    ...
    resolve_host: proc "c" (self: ^cef_request_context_t, origin: ^cef_string, callback: ^cef_resolve_callback_t),
    get_media_router: proc "c" (self: ^cef_request_context_t, callback: ^cef_completion_callback_t) -> ^cef_media_router_t,
    get_website_setting: proc "c" (self: ^cef_request_context_t, requesting_url: ^cef_string, top_level_url: ^cef_string, content_type: cef_content_setting_types_t) -> ^cef_value_t,
    set_website_setting: proc "c" (self: ^cef_request_context_t, requesting_url: ^cef_string, top_level_url: ^cef_string, content_type: cef_content_setting_types_t, value: ^cef_value_t),
    get_content_setting: proc "c" (self: ^cef_request_context_t, requesting_url: ^cef_string, top_level_url: ^cef_string, content_type: cef_content_setting_types_t) -> cef_content_setting_values_t,
    set_content_setting: proc "c" (self: ^cef_request_context_t, requesting_url: ^cef_string, top_level_url: ^cef_string, content_type: cef_content_setting_types_t, value: cef_content_setting_values_t),
