...
drag_handler :: struct {
	...
	on_drag_enter: proc "c" (self: ^drag_handler, browser: ^Browser, dragData: ^drag_data, mask: cef_drag_operations_mask) -> b32,
	...
	on_draggable_regions_changed: proc "c" (self: ^drag_handler, browser: ^Browser, frame: ^Frame, regionsCount: c.size_t, regions: ^cef_draggable_region),
} 