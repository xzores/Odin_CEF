...
Drag_handler :: struct {
	...
	on_drag_enter: proc "c" (self: ^Drag_handler, browser: ^Browser, dragData: ^Drag_data, mask: Drag_operations_mask) -> b32,
	...
	on_draggable_regions_changed: proc "c" (self: ^Drag_handler, browser: ^Browser, frame: ^Frame, regionsCount: c.size_t, regions: ^Draggable_region),
} 