...
Browser :: struct {
    ...
    ///
    is_valid: proc "c" (self: ^Browser) -> b32,
    ...
    ///
    can_go_back: proc "c" (self: ^Browser) -> b32,
    ...
    ///
    can_go_forward: proc "c" (self: ^Browser) -> b32,
    ...
    ///
    is_loading: proc "c" (self: ^Browser) -> b32,
    ...
    /// object.
    ///
    is_same: proc "c" (self: ^Browser, that: ^Browser) -> b32,

    ///
    /// Returns true (1) if the browser is a popup.
    ///
    is_popup: proc "c" (self: ^Browser) -> b32,

    ///
    /// Returns true (1) if a document has been loaded in the browser.
    ///
    has_document: proc "c" (self: ^Browser) -> b32,
    ...
    ///
    get_frame_by_identifier: proc "c" (self: ^Browser, identifier: ^cef_string) -> ^Frame,

    ///
    /// Returns the frame with the specified name, or nil if not found.
    ///
    get_frame_by_name: proc "c" (self: ^Browser, name: ^cef_string) -> ^Frame,
}
