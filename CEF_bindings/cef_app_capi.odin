...
foreign lib {
	...
	///
	execute_process :: proc "c" (args: ^cef_main_args, application: ^App, windows_sandbox_info: rawptr) -> c.int ---
	...
	///
	initialize :: proc "c" (args: ^cef_main_args, settings: ^cef_settings, application: ^App, windows_sandbox_info: rawptr) -> c.int ---
