...
///
/// Implement this structure to handle events related to browser lifespan. The
...
cef_life_span_handler_t :: struct {
    ...
    /// additional details.
    ///
    on_before_popup: proc "c" (self: ^cef_life_span_handler_t, browser: ^cef_browser_t, frame: ^cef_frame_t, popup_id: c.int, target_url: ^cef_string_t, target_frame_name: ^cef_string_t, target_disposition: cef_window_open_disposition, user_gesture: b32, popupFeatures: ^cef_popup_features, windowInfo: ^cef_window_info, client: ^^cef_client_t, settings: ^cef_browser_settings, extra_info: ^^cef_dictionary_value, no_javascript_access: ^b32) -> b32,

    ///
    /// Called on the UI thread if a new popup browser is aborted. This only
    /// occurs if the popup is allowed in on_before_popup and creation fails before
    ...
    /// on_before_popup_aborted, on_after_created of the popup browser, or
    ...
    ///
    on_before_popup_aborted: proc "c" (self: ^cef_life_span_handler_t, browser: ^cef_browser_t, popup_id: c.int),
    ...
    ///
    on_before_dev_tools_popup: proc "c" (self: ^cef_life_span_handler_t, browser: ^cef_browser_t, windowInfo: ^cef_window_info, client: ^^cef_client_t, settings: ^cef_browser_settings, extra_info: ^^cef_dictionary_value, use_default_window: ^b32),
    ...
    ///
    on_after_created: proc "c" (self: ^cef_life_span_handler_t, browser: ^cef_browser_t),
    ...
    /// by calling browser_host::try_close_browser() or
    ...
    ///
    /// The life_span_handler::on_before_close() function will be called
    /// after do_close() (if do_close() is called) and immediately before the
    /// browser object is destroyed. The application should only exit after
    /// on_before_close() has been called for all existing browsers.
    ///
    do_close: proc "c" (self: ^cef_life_span_handler_t, browser: ^cef_browser_t) -> b32,
    ...
    ///
    on_before_close: proc "c" (self: ^cef_life_span_handler_t, browser: ^cef_browser_t),
} 