...
cef_menu_model_t :: struct {
    ...
    add_item: proc "c" (self: ^cef_menu_model_t, command_id: c.int, label: ^cef_string_t) -> b32,
    add_check_item: proc "c" (self: ^cef_menu_model_t, command_id: c.int, label: ^cef_string_t) -> b32,
    add_radio_item: proc "c" (self: ^cef_menu_model_t, command_id: c.int, label: ^cef_string_t, group_id: c.int) -> b32,
    add_sub_menu: proc "c" (self: ^cef_menu_model_t, command_id: c.int, label: ^cef_string_t) -> ^cef_menu_model_t,
    insert_separator_at: proc "c" (self: ^cef_menu_model_t, index: c.size_t) -> b32,
    insert_item_at: proc "c" (self: ^cef_menu_model_t, index: c.size_t, command_id: c.int, label: ^cef_string_t) -> b32,
    insert_check_item_at: proc "c" (self: ^cef_menu_model_t, index: c.size_t, command_id: c.int, label: ^cef_string_t) -> b32,
    insert_radio_item_at: proc "c" (self: ^cef_menu_model_t, index: c.size_t, command_id: c.int, label: ^cef_string_t, group_id: c.int) -> b32,
    insert_sub_menu_at: proc "c" (self: ^cef_menu_model_t, index: c.size_t, command_id: c.int, label: ^cef_string_t) -> ^cef_menu_model_t,
    ...
    get_label: proc "c" (self: ^cef_menu_model_t, command_id: c.int) -> cef_string_userfree_t,
    get_label_at: proc "c" (self: ^cef_menu_model_t, index: c.size_t) -> cef_string_userfree_t,
    set_label: proc "c" (self: ^cef_menu_model_t, command_id: c.int, label: ^cef_string_t) -> b32,
    set_label_at: proc "c" (self: ^cef_menu_model_t, index: c.size_t, label: ^cef_string_t) -> b32,
    ...
    set_font_list: proc "c" (self: ^cef_menu_model_t, command_id: c.int, font_list: ^cef_string_t) -> b32,
    set_font_list_at: proc "c" (self: ^cef_menu_model_t, index: c.int, font_list: ^cef_string_t) -> b32,
}
