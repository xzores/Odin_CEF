...
cef_media_router_t :: struct {
    ...
    get_source: proc "c" (self: ^cef_media_router_t, urn: ^cef_string_t) -> ^cef_media_source_t,
...
cef_media_route_t :: struct {
    ...
    get_id: proc "c" (self: ^cef_media_route_t) -> cef_string_userfree_t,
...
cef_media_route_create_callback_t :: struct {
    ...
    on_media_route_create_finished: proc "c" (self: ^cef_media_route_create_callback_t, result: cef_media_route_create_result_t, error: ^cef_string_t, route: ^cef_media_route_t),
}

cef_media_sink_t :: struct {
    base: cef_base_ref_counted_t,
    
    get_id: proc "c" (self: ^cef_media_sink_t) -> cef_string_userfree_t,
    get_name: proc "c" (self: ^cef_media_sink_t) -> cef_string_userfree_t,
...
cef_media_source_t :: struct {
    ...
    get_id: proc "c" (self: ^cef_media_source_t) -> cef_string_userfree_t,
