...
cef_app_t :: struct {
    ...
    ///
    on_before_command_line_processing: proc "c" (self: ^cef_app_t, process_type: ^cef_string, command_line: ^command_line),
    ...
    ///
    on_register_custom_schemes: proc "c" (self: ^cef_app_t, registrar: ^scheme_registrar),
    ...
    ///
    get_resource_bundle_handler: proc "c" (self: ^cef_app_t) -> ^resource_bundle_handler,

    ///
    /// Return the handler for functionality specific to the browser process. This
    /// function is called on multiple threads in the browser process.
    ///
    get_browser_process_handler: proc "c" (self: ^cef_app_t) -> ^browser_process_handler,

    ///
    /// Return the handler for functionality specific to the render process. This
    /// function is called on the render process main thread.
    ///
    get_render_process_handler: proc "c" (self: ^cef_app_t) -> ^render_process_handler,
}
...
///
execute_process :: proc "c" (args: ^cef_main_args, application: ^cef_app_t, windows_sandbox_info: rawptr) -> c.int
...
///
initialize :: proc "c" (args: ^cef_main_args, settings: ^cef_settings, application: ^cef_app_t, windows_sandbox_info: rawptr) -> c.int

///
/// This function can optionally be called on the main application thread after
/// initialize to retrieve the initialization exit code. When initialize
...
/// run_message_loop(). This function should only be called on the main
