...
find_handler :: struct {
    ...
    /// notification.
    ///
    on_find_result: proc "c" (self: ^find_handler, browser: ^cef_browser_t, identifier: c.int, count: c.int, selectionRect: ^cef_rect, activeMatchOrdinal: c.int, finalUpdate: b32),
} 