...
permission_handler :: struct {
    ...
    ///
    on_request_media_access_permission: proc "c" (self: ^permission_handler, browser: ^cef_browser_t, frame: ^frame, requesting_origin: ^cef_string, requested_permissions: u32, callback: ^media_access_callback) -> b32,
    ...
    ///
    on_show_permission_prompt: proc "c" (self: ^permission_handler, browser: ^cef_browser_t, prompt_id: u64, requesting_origin: ^cef_string, requested_permissions: u32, callback: ^permission_prompt_callback) -> b32,
    ...
    ///
    on_dismiss_permission_prompt: proc "c" (self: ^permission_handler, browser: ^cef_browser_t, prompt_id: u64, result: cef_permission_request_result),
} 