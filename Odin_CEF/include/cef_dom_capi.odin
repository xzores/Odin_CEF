...
cef_dom_document_type_t :: enum c.int {}
cef_dom_node_type_t :: enum c.int {}
cef_dom_form_control_type_t :: enum c.int {}
cef_string_map_t :: struct {}
// cef_rect_t :: struct {}
...
cef_domdocument_t :: struct {
    ...
    get_title: proc "c" (self: ^cef_domdocument_t) -> cef_string_userfree_t,
    get_element_by_id: proc "c" (self: ^cef_domdocument_t, id: ^cef_string_t) -> ^cef_domnode_t,
    ...
    get_selection_as_markup: proc "c" (self: ^cef_domdocument_t) -> cef_string_userfree_t,
    get_selection_as_text: proc "c" (self: ^cef_domdocument_t) -> cef_string_userfree_t,
    get_base_url: proc "c" (self: ^cef_domdocument_t) -> cef_string_userfree_t,
    get_complete_url: proc "c" (self: ^cef_domdocument_t, partial_url: ^cef_string_t) -> cef_string_userfree_t,
}
...
cef_domnode_t :: struct {
    ...
    get_name: proc "c" (self: ^cef_domnode_t) -> cef_string_userfree_t,
    get_value: proc "c" (self: ^cef_domnode_t) -> cef_string_userfree_t,
    set_value: proc "c" (self: ^cef_domnode_t, value: ^cef_string_t) -> b32,
    get_as_markup: proc "c" (self: ^cef_domnode_t) -> cef_string_userfree_t,
    ...
    get_element_tag_name: proc "c" (self: ^cef_domnode_t) -> cef_string_userfree_t,
    has_element_attributes: proc "c" (self: ^cef_domnode_t) -> b32,
    has_element_attribute: proc "c" (self: ^cef_domnode_t, attr_name: ^cef_string_t) -> b32,
    get_element_attribute: proc "c" (self: ^cef_domnode_t, attr_name: ^cef_string_t) -> cef_string_userfree_t,
    get_element_attributes: proc "c" (self: ^cef_domnode_t, attr_map: cef_string_map_t),
    set_element_attribute: proc "c" (self: ^cef_domnode_t, attr_name: ^cef_string_t, value: ^cef_string_t) -> b32,
    get_element_inner_text: proc "c" (self: ^cef_domnode_t) -> cef_string_userfree_t,
    get_element_bounds: proc "c" (self: ^cef_domnode_t) -> cef_rect_t,
} 