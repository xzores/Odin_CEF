...
keyboard_handler :: struct {
    ...
    /// (0).
    ///
    on_pre_key_event: proc "c" (self: ^keyboard_handler, browser: ^cef_browser_t, event: ^cef_key_event, os_event: cef_event_handle, is_keyboard_shortcut: ^b32) -> b32,
    ...
    ///
    on_key_event: proc "c" (self: ^keyboard_handler, browser: ^cef_browser_t, event: ^cef_key_event, os_event: cef_event_handle) -> b32,
} 