...
/// discarded).
///
/// When the main frame navigates to a different origin the on_main_frame_changed
...
frame_handler :: struct {
    ...
    /// attaches.
    ///
    on_frame_created: proc "c" (self: ^frame_handler, browser: ^cef_browser_t, frame: ^frame),

    ///
    /// Called when an existing frame is destroyed. This will be the last
    /// notification that references |frame| and frame::is_valid() will
    ...
    ///
    on_frame_destroyed: proc "c" (self: ^frame_handler, browser: ^cef_browser_t, frame: ^frame),
    ...
    ///
    on_frame_attached: proc "c" (self: ^frame_handler, browser: ^cef_browser_t, frame: ^frame, reattached: b32),
    ...
    /// origin navigation.
    ///
    on_frame_detached: proc "c" (self: ^frame_handler, browser: ^cef_browser_t, frame: ^frame),
    ...
    ///
    on_main_frame_changed: proc "c" (self: ^frame_handler, browser: ^cef_browser_t, old_frame: ^frame, new_frame: ^frame),
} 