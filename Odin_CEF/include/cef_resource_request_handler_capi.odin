...
resource_request_handler :: struct {
    ...
    ///
    get_cookie_access_filter: proc "c" (self: ^resource_request_handler, browser: ^cef_browser_t, frame: ^frame, request: ^request) -> ^cookie_access_filter,
    ...
    /// immediately.
    ///
    on_before_resource_load: proc "c" (self: ^resource_request_handler, browser: ^cef_browser_t, frame: ^frame, request: ^request, callback: ^callback) -> cef_return_value,
    ...
    ///
    get_resource_handler: proc "c" (self: ^resource_request_handler, browser: ^cef_browser_t, frame: ^frame, request: ^request) -> ^resource_handler,
    ...
    ///
    on_resource_redirect: proc "c" (self: ^resource_request_handler, browser: ^cef_browser_t, frame: ^frame, request: ^request, response: ^response, new_url: ^cef_string),
    ...
    ///
    on_resource_response: proc "c" (self: ^resource_request_handler, browser: ^cef_browser_t, frame: ^frame, request: ^request, response: ^response) -> b32,
    ...
    ///
    get_resource_response_filter: proc "c" (self: ^resource_request_handler, browser: ^cef_browser_t, frame: ^frame, request: ^request, response: ^response) -> ^response_filter,
    ...
    ///
    on_resource_load_complete: proc "c" (self: ^resource_request_handler, browser: ^cef_browser_t, frame: ^frame, request: ^request, response: ^response, status: cef_urlrequest_status, received_content_length: i64),
    ...
    ///
    on_protocol_execution: proc "c" (self: ^resource_request_handler, browser: ^cef_browser_t, frame: ^frame, request: ^request, allow_os_execution: ^b32),
}
...
cookie_access_filter :: struct {
    ...
    ///
    can_send_cookie: proc "c" (self: ^cookie_access_filter, browser: ^cef_browser_t, frame: ^frame, request: ^request, cookie: ^cef_cookie) -> b32,
    ...
    /// otherwise.
    ///
    can_save_cookie: proc "c" (self: ^cookie_access_filter, browser: ^cef_browser_t, frame: ^frame, request: ^request, response: ^response, cookie: ^cef_cookie) -> b32,
} 