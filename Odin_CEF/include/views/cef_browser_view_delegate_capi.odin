...
cef_browser_view_delegate_t :: struct {
    ...
    on_browser_created: proc "c" (self: ^cef_browser_view_delegate_t, browser_view: ^cef_browser_view_t, browser: ^cef_browser_t),
    on_browser_destroyed: proc "c" (self: ^cef_browser_view_delegate_t, browser_view: ^cef_browser_view_t, browser: ^cef_browser_t),
