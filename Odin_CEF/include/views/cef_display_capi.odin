...
cef_display_t :: struct {
    ...
    convert_rect_to_pixels: proc "c" (self: ^cef_display_t, rect: ^cef_rect_t) -> cef_rect_t,
    convert_rect_from_pixels: proc "c" (self: ^cef_display_t, rect: ^cef_rect_t) -> cef_rect_t,
    get_bounds: proc "c" (self: ^cef_display_t) -> cef_rect_t,
    get_work_area: proc "c" (self: ^cef_display_t) -> cef_rect_t,
