...
cef_button_t :: struct {
    ...
    set_text: proc "c" (self: ^cef_button_t, text: ^cef_string_t),
    get_text: proc "c" (self: ^cef_button_t) -> cef_string_userfree_t,
    ...
    set_font_list: proc "c" (self: ^cef_button_t, font_list: ^cef_string_t),
    ...
    set_button_text: proc "c" (self: ^cef_button_t, text: ^cef_string_t),
    get_button_text: proc "c" (self: ^cef_button_t) -> cef_string_userfree_t,
