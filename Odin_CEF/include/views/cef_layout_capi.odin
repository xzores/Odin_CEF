...
cef_layout_t :: struct {
    ...
    set_bounds: proc "c" (self: ^cef_layout_t, bounds: ^cef_rect_t),
    get_bounds: proc "c" (self: ^cef_layout_t) -> cef_rect_t,
    get_bounds_in_screen: proc "c" (self: ^cef_layout_t) -> cef_rect_t,
    ...
    set_child_view_bounds: proc "c" (self: ^cef_layout_t, view: ^cef_view_t, bounds: ^cef_rect_t),
    get_child_view_bounds: proc "c" (self: ^cef_layout_t, view: ^cef_view_t) -> cef_rect_t,
} 