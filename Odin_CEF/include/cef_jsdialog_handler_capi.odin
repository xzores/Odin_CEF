...
jsdialog_handler :: struct {
    ...
    /// dialog is dismissed.
    ///
    on_jsdialog: proc "c" (self: ^jsdialog_handler, browser: ^cef_browser_t, origin_url: ^cef_string, dialog_type: cef_jsdialog_type, message_text: ^cef_string, default_prompt_text: ^cef_string, callback: ^jsdialog_callback, suppress_message: ^b32) -> b32,
    ...
    ///
    on_before_unload_dialog: proc "c" (self: ^jsdialog_handler, browser: ^cef_browser_t, message_text: ^cef_string, is_reload: b32, callback: ^jsdialog_callback) -> b32,
    ...
    ///
    on_reset_dialog_state: proc "c" (self: ^jsdialog_handler, browser: ^cef_browser_t),

    ///
    /// Called when the dialog is closed.
    ///
    on_dialog_closed: proc "c" (self: ^jsdialog_handler, browser: ^cef_browser_t),
} 