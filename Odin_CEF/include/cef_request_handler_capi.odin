...
request_handler :: struct {
    ...
    ///
    on_before_browse: proc "c" (self: ^request_handler, browser: ^cef_browser_t, frame: ^frame, request: ^request, user_gesture: b32, is_redirect: b32) -> b32,
    ...
    ///
    on_open_urlfrom_tab: proc "c" (self: ^request_handler, browser: ^cef_browser_t, frame: ^frame, target_url: ^cef_string, target_disposition: cef_window_open_disposition, user_gesture: b32) -> b32,
    ...
    ///
    get_resource_request_handler: proc "c" (self: ^request_handler, browser: ^cef_browser_t, frame: ^frame, request: ^request, is_navigation: b32, is_download: b32, request_initiator: ^cef_string, disable_default_handling: ^b32) -> ^resource_request_handler,
    ...
    ///
    get_auth_credentials: proc "c" (self: ^request_handler, browser: ^cef_browser_t, origin_url: ^cef_string, isProxy: b32, host: ^cef_string, port: c.int, realm: ^cef_string, scheme: ^cef_string, callback: ^auth_callback) -> b32,

    ///
    /// Called on the UI thread to handle requests for URLs with an invalid SSL
    /// certificate. Return true (1) and call callback functions either in
    ...
    ///
    on_certificate_error: proc "c" (self: ^request_handler, browser: ^cef_browser_t, cert_error: cef_errorcode, request_url: ^cef_string, ssl_info: ^ssl_info, callback: ^callback) -> b32,
    ...
    /// server trusts.
    ///
    on_select_client_certificate: proc "c" (self: ^request_handler, browser: ^cef_browser_t, isProxy: b32, host: ^cef_string, port: c.int, certificatesCount: c.size_t, certificates: ^^x509_certificate, callback: ^select_client_certificate_callback) -> b32,
    ...
    /// process.
    ///
    on_render_view_ready: proc "c" (self: ^request_handler, browser: ^cef_browser_t),
    ...
    ///
    on_render_process_unresponsive: proc "c" (self: ^request_handler, browser: ^cef_browser_t, callback: ^unresponsive_process_callback) -> b32,
    ...
    ///
    on_render_process_responsive: proc "c" (self: ^request_handler, browser: ^cef_browser_t),
    ...
    ///
    on_render_process_terminated: proc "c" (self: ^request_handler, browser: ^cef_browser_t, status: cef_termination_status, error_code: c.int, error_string: ^cef_string),

    ///
    /// Called on the browser process UI thread when the window.document object of
    /// the main frame has been created.
    ///
    on_document_available_in_main_frame: proc "c" (self: ^request_handler, browser: ^cef_browser_t),
} 