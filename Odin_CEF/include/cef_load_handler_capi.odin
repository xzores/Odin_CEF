...
load_handler :: struct {
    ...
    ///
    on_loading_state_change: proc "c" (self: ^load_handler, browser: ^cef_browser_t, isLoading: b32, canGoBack: b32, canGoForward: b32),
    ...
    ///
    on_load_start: proc "c" (self: ^load_handler, browser: ^cef_browser_t, frame: ^frame, transition_type: cef_transition_type),
    ...
    /// instead.
    ///
    on_load_end: proc "c" (self: ^load_handler, browser: ^cef_browser_t, frame: ^frame, httpStatusCode: c.int),
    ...
    ///
    on_load_error: proc "c" (self: ^load_handler, browser: ^cef_browser_t, frame: ^frame, errorCode: cef_errorcode, errorText: ^cef_string, failedUrl: ^cef_string),
} 