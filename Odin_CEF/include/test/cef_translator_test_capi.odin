...
cef_translator_test_t :: struct {
    ...
    get_string: proc "c" (self: ^cef_translator_test_t) -> common.cef_string_userfree_t,
    set_string: proc "c" (self: ^cef_translator_test_t, val: ^common.cef_string_t) -> c.int,
    get_string_by_ref: proc "c" (self: ^cef_translator_test_t, val: ^common.cef_string_t),
    set_string_list: proc "c" (self: ^cef_translator_test_t, val: common.cef_string_list_t) -> c.int,
    get_string_list_by_ref: proc "c" (self: ^cef_translator_test_t, val: common.cef_string_list_t) -> c.int,
