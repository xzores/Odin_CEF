...
v8_handler :: struct {
    ...
    ///
    execute: proc "c" (self: ^v8_handler, name: ^cef_string, object: ^v8_value, argumentsCount: c.size_t, arguments: ^^v8_value, retval: ^^v8_value, exception: ^cef_string) -> b32,
}

///
/// Structure that should be implemented to handle V8 accessor calls. Accessor
/// identifiers are registered by calling v8_value::set_value(). The
/// functions of this structure will be called on the thread associated with the
/// V8 accessor.
///
/// NOTE: This struct is allocated client-side.
...
v8_accessor :: struct {
    ...
    /// handled.
    ///
    get: proc "c" (self: ^v8_accessor, name: ^cef_string, object: ^v8_value, retval: ^^v8_value, exception: ^cef_string) -> b32,
    ...
    /// handled.
    ///
    set: proc "c" (self: ^v8_accessor, name: ^cef_string, object: ^v8_value, value: ^v8_value, exception: ^cef_string) -> b32,
}
...
v8_interceptor :: struct {
    ...
    ///
    get_byname: proc "c" (self: ^v8_interceptor, name: ^cef_string, object: ^v8_value, retval: ^^v8_value, exception: ^cef_string) -> b32,
    ...
    ///
    get_byindex: proc "c" (self: ^v8_interceptor, index: c.int, object: ^v8_value, retval: ^^v8_value, exception: ^cef_string) -> b32,
    ...
    ///
    set_byname: proc "c" (self: ^v8_interceptor, name: ^cef_string, object: ^v8_value, value: ^v8_value, exception: ^cef_string) -> b32,
    ...
    ///
    set_byindex: proc "c" (self: ^v8_interceptor, index: c.int, object: ^v8_value, value: ^v8_value, exception: ^cef_string) -> b32,
}
...
///
/// Structure that should be implemented to handle V8 ArrayBuffer memory
/// release. The functions of this structure will be called on the thread
...
v8_array_buffer_release_callback :: struct {
    ...
    /// collected. |buffer| is the value that was passed to create_array_buffer
...
v8_value :: struct {
    ...
    /// returns false (0).
    ///
    is_valid: proc "c" (self: ^v8_value) -> b32,

    ///
    /// True if the value type is undefined.
    ///
    is_undefined: proc "c" (self: ^v8_value) -> b32,

    ///
    /// True if the value type is null.
    ///
    is_null: proc "c" (self: ^v8_value) -> b32,

    ///
    /// True if the value type is bool.
    ///
    is_bool: proc "c" (self: ^v8_value) -> b32,

    ///
    /// True if the value type is int.
    ///
    is_int: proc "c" (self: ^v8_value) -> b32,

    ///
    /// True if the value type is unsigned int.
    ///
    is_uint: proc "c" (self: ^v8_value) -> b32,

    ///
    /// True if the value type is double.
    ///
    is_double: proc "c" (self: ^v8_value) -> b32,

    ///
    /// True if the value type is Date.
    ///
    is_date: proc "c" (self: ^v8_value) -> b32,

    ///
    /// True if the value type is string.
    ///
    is_string: proc "c" (self: ^v8_value) -> b32,

    ///
    /// True if the value type is object.
    ///
    is_object: proc "c" (self: ^v8_value) -> b32,

    ///
    /// True if the value type is array.
    ///
    is_array: proc "c" (self: ^v8_value) -> b32,

    ///
    /// True if the value type is an ArrayBuffer.
    ///
    is_array_buffer: proc "c" (self: ^v8_value) -> b32,

    ///
    /// True if the value type is function.
    ///
    is_function: proc "c" (self: ^v8_value) -> b32,

    ///
    /// True if the value type is a Promise.
    ///
    is_promise: proc "c" (self: ^v8_value) -> b32,

    ///
    /// Returns true (1) if this object is pointing to the same handle as |that|
    /// object.
    ///
    is_same: proc "c" (self: ^v8_value, that: ^v8_value) -> b32,

    ///
    /// Return a bool value.
    ///
    get_bool_value: proc "c" (self: ^v8_value) -> b32,

    ///
    /// Return an int value.
    ///
    get_int_value: proc "c" (self: ^v8_value) -> i32,

    ///
    /// Return an unsigned int value.
    ///
    get_uint_value: proc "c" (self: ^v8_value) -> u32,

    ///
    /// Return a double value.
    ///
    get_double_value: proc "c" (self: ^v8_value) -> f64,
    ...
    ///
    get_string_value: proc "c" (self: ^v8_value) -> cef_string_userfree,

    ///
    /// Returns true (1) if this is a user created object.
    ///
    is_user_created: proc "c" (self: ^v8_value) -> b32,

    ///
    /// Returns true (1) if the last function call resulted in an exception. This
    /// attribute exists only in the scope of the current CEF value object.
    ///
    has_exception: proc "c" (self: ^v8_value) -> b32,
    ...
    ///
    clear_exception: proc "c" (self: ^v8_value) -> b32,

    ///
    /// Returns true (1) if this object will re-throw future exceptions. This
    /// attribute exists only in the scope of the current CEF value object.
    ///
    will_rethrow_exceptions: proc "c" (self: ^v8_value) -> b32,
    ...
    ///
    set_rethrow_exceptions: proc "c" (self: ^v8_value, rethrow: b32) -> b32,

    ///
    /// Returns true (1) if the object has a value with the specified identifier.
    ///
    has_value_bykey: proc "c" (self: ^v8_value, key: ^cef_string) -> b32,

    ///
    /// Returns true (1) if the object has a value with the specified identifier.
    ///
    has_value_byindex: proc "c" (self: ^v8_value, index: c.int) -> b32,
    ...
    ///
    delete_value_bykey: proc "c" (self: ^v8_value, key: ^cef_string) -> b32,
    ...
    ///
    delete_value_byindex: proc "c" (self: ^v8_value, index: c.int) -> b32,

    ///
    /// Returns the value with the specified identifier on success. Returns NULL
    /// if this function is called incorrectly or an exception is thrown.
    ///
    get_value_bykey: proc "c" (self: ^v8_value, key: ^cef_string) -> ^v8_value,
    ...
    /// (1) even though assignment failed.
    ///
    set_value_byindex: proc "c" (self: ^v8_value, index: c.int, value: ^v8_value) -> b32,

    ///
    /// Registers an identifier and returns true (1) on success. Access to the
    /// identifier will be forwarded to the v8_accessor instance passed to
    ...
    ///
    get_keys: proc "c" (self: ^v8_value, keys: cef_string_list) -> b32,
    ...
    ///
    set_user_data: proc "c" (self: ^v8_value, user_data: ^base_ref_counted) -> b32,

    ///
    /// Returns the user data, if any, assigned to this object.
    ///
    get_user_data: proc "c" (self: ^v8_value) -> ^base_ref_counted,

    ///
    /// Returns the amount of externally allocated memory registered for the
    /// object.
    ///
    get_externally_allocated_memory: proc "c" (self: ^v8_value) -> c.int,
    ...
    ///
    adjust_externally_allocated_memory: proc "c" (self: ^v8_value, change_in_bytes: c.int) -> c.int,

    ///
    /// Returns the number of elements in the array.
    ///
    get_array_length: proc "c" (self: ^v8_value) -> c.int,

    ///
    /// Returns the release_callback object associated with the ArrayBuffer or NULL
    /// if the ArrayBuffer was not created with create_array_buffer.
    ///
    get_array_buffer_release_callback: proc "c" (self: ^v8_value) -> ^v8_array_buffer_release_callback,
    ...
    ///
    neuter_array_buffer: proc "c" (self: ^v8_value) -> b32,

    ///
    /// Returns the length (in bytes) of the ArrayBuffer.
    ///
    get_array_buffer_byte_length: proc "c" (self: ^v8_value) -> c.size_t,
    ...
    /// v8_value is alive.
    ///
    get_array_buffer_data: proc "c" (self: ^v8_value) -> rawptr,

    ///
    /// Returns the function name.
    ///
    get_function_name: proc "c" (self: ^v8_value) -> cef_string_userfree,

    ///
    /// Returns the function handler or NULL if not a CEF-created function.
    ///
    get_function_handler: proc "c" (self: ^v8_value) -> ^v8_handler,
    ...
    /// thrown.
    ///
    execute_function: proc "c" (self: ^v8_value, object: ^v8_value, argumentsCount: c.size_t, arguments: ^^v8_value) -> ^v8_value,
    ...
    ///
    resolve_promise: proc "c" (self: ^v8_value, arg: ^v8_value) -> b32,
...
///
v8_value_create_undefined :: proc "c" () -> ^v8_value

///
/// Create a new v8_value object of type null.
///
v8_value_create_null :: proc "c" () -> ^v8_value

///
/// Create a new v8_value object of type bool.
///
v8_value_create_bool :: proc "c" (value: b32) -> ^v8_value

///
/// Create a new v8_value object of type int.
///
v8_value_create_int :: proc "c" (value: i32) -> ^v8_value

///
/// Create a new v8_value object of type unsigned int.
///
v8_value_create_uint :: proc "c" (value: u32) -> ^v8_value

///
/// Create a new v8_value object of type double.
///
v8_value_create_double :: proc "c" (value: f64) -> ^v8_value
...
///
v8_value_create_string :: proc "c" (value: ^cef_string) -> ^v8_value
...
/// structure may be called on any render process thread.
///
/// NOTE: This struct is allocated DLL-side.
///
...
///
/// Structure representing a V8 stack frame handle. The functions of this
/// structure may be called on any render process thread.
///
/// NOTE: This struct is allocated DLL-side.
///
v8_stack_frame :: struct {
    ...
    /// returns false (0).
    ///
    is_valid: proc "c" (self: ^v8_stack_frame) -> b32,

    ///
    /// Returns the name of the resource script that contains the function.
    ///
    get_script_name: proc "c" (self: ^v8_stack_frame) -> cef_string_userfree,
    ...
    /// "//@ sourceURL=..." string.
    ///
    get_script_name_or_source_url: proc "c" (self: ^v8_stack_frame) -> cef_string_userfree,

    ///
    /// Returns the name of the function.
    ///
    get_function_name: proc "c" (self: ^v8_stack_frame) -> cef_string_userfree,
    ...
    ///
    is_eval: proc "c" (self: ^v8_stack_frame) -> b32,

    ///
    /// Returns true (1) if the function was called as a constructor via "new".
    ///
    is_constructor: proc "c" (self: ^v8_stack_frame) -> b32,
}

///
/// Register a new V8 extension with the specified |extension_name| and
/// |javascript_code|. JavaScript code should be wrapped in a function
...
///
register_extension :: proc "c" (extension_name: ^cef_string, javascript_code: ^cef_string, handler: ^v8_handler) -> b32 