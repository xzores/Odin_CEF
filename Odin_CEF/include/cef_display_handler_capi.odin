...
display_handler :: struct {
    ...
    ///
    on_address_change: proc "c" (self: ^display_handler, browser: ^cef_browser_t, frame: ^frame, url: ^cef_string),

    ///
    /// Called when the page title changes.
    ///
    on_title_change: proc "c" (self: ^display_handler, browser: ^cef_browser_t, title: ^cef_string),

    ///
    /// Called when the page icon changes.
    ///
    on_favicon_urlchange: proc "c" (self: ^display_handler, browser: ^cef_browser_t, icon_urls: cef_string_list),
    ...
    ///
    on_fullscreen_mode_change: proc "c" (self: ^display_handler, browser: ^cef_browser_t, fullscreen: b32),
    ...
    ///
    on_tooltip: proc "c" (self: ^display_handler, browser: ^cef_browser_t, text: ^cef_string) -> b32,

    ///
    /// Called when the browser receives a status message. |value| contains the
    /// text that will be displayed in the status message.
    ///
    on_status_message: proc "c" (self: ^display_handler, browser: ^cef_browser_t, value: ^cef_string),

    ///
    /// Called to display a console message. Return true (1) to stop the message
    /// from being output to the console.
    ///
    on_console_message: proc "c" (self: ^display_handler, browser: ^cef_browser_t, level: cef_log_severity, message: ^cef_string, source: ^cef_string, line: c.int) -> b32,

    ///
    /// Called when auto-resize is enabled via
    /// browser_host::set_auto_resize_enabled and the contents have auto-
    /// resized. |new_size| will be the desired size in DIP coordinates. Return
    /// true (1) if the resize was handled or false (0) for default handling.
    ///
    on_auto_resize: proc "c" (self: ^display_handler, browser: ^cef_browser_t, new_size: ^cef_size) -> b32,

    ///
    /// Called when the overall page loading progress has changed. |progress|
    /// ranges from 0.0 to 1.0.
    ///
    on_loading_progress_change: proc "c" (self: ^display_handler, browser: ^cef_browser_t, progress: f64),
    ...
    /// handling.
    ///
    on_cursor_change: proc "c" (self: ^display_handler, browser: ^cef_browser_t, cursor: cef_cursor_handle, type: cef_cursor_type, custom_cursor_info: ^cef_cursor_info) -> b32,

    ///
    /// Called when the browser's access to an audio and/or video source has
    /// changed.
    ///
    on_media_access_change: proc "c" (self: ^display_handler, browser: ^cef_browser_t, has_video_access: b32, has_audio_access: b32),
    ...
    /// containing window and may be passed directly to
    ...
    ///
    on_contents_bounds_change: proc "c" (self: ^display_handler, browser: ^cef_browser_t, new_bounds: ^cef_rect) -> b32,
    ...
    ///
    get_root_window_screen_rect: proc "c" (self: ^display_handler, browser: ^cef_browser_t, rect: ^cef_rect) -> b32,
} 