...
focus_handler :: struct {
    ...
    /// component.
    ///
    on_take_focus: proc "c" (self: ^focus_handler, browser: ^cef_browser_t, next: b32),
    ...
    ///
    on_set_focus: proc "c" (self: ^focus_handler, browser: ^cef_browser_t, source: cef_focus_source) -> b32,

    ///
    /// Called when the browser component has received focus.
    ///
    on_got_focus: proc "c" (self: ^focus_handler, browser: ^cef_browser_t),
} 